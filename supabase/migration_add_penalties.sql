-- Migration: Add Penalty Trigger System
-- Run this in your Supabase SQL editor (after migration_add_journal.sql)

-- Add penalty columns to users table
ALTER TABLE public.users
  ADD COLUMN IF NOT EXISTS penalty_rules JSONB DEFAULT '[
